...
function Edit({
  ...
  const changeBlockType = e => {
    setAttributes({
      block_type: e.target.dataset.val
    });
  };
  const [all_categories, setAllCategories] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)([]);
  ...
  const [defaultPosts, setAllPosts] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useState)([]);
  const queryParams = {
    posts_per_page: -1
  };
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
    ...
    _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_2___default()({
      path: (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_4__.addQueryArgs)('/wp/v2/posts', queryParams)
    }).then(result => {
      setAllPosts(result);
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    "data-val": "static",
    onClick: changeBlockType,
    variant: "tertiary",
    isPressed: 'static' === block_type ? true : false
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Static Block', 'h-lakkad')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.Button, {
    "data-val": "dynamic_gb",
    onClick: changeBlockType,
    variant: "tertiary",
    isPressed: 'dynamic_gb' === block_type ? true : false
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Dynamic Block', 'h-lakkad'))), 'static' === block_type ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "static-block-option-container"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h4", null, "Static Block Settings"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "static-posts-listing"
  }, attributes.static_posts.length >= 1 ? attributes.static_posts.map((location, index) => {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      key: index,
      className: "static-post-item"
      ...
      render: ({
        open
      }) => attributes.static_posts[index].mediaId === '' || undefined === attributes.static_posts[index].mediaId ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.Button, {
        variant: "secondary",
        onClick: open
      }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Select Image', 'h-lakkad')) : ''
    })), '' !== attributes.static_posts[index].mediaURL && undefined !== attributes.static_posts[index].mediaURL ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.ResponsiveWrapper, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
      height: 70,
      width: 70,
      src: attributes.static_posts[index].mediaURL
    }))) : '', (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.Button, {
      variant: "primary",
      onClick: () => removePost(index)
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Remove Post', 'h-lakkad')));
  }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('No data', 'h-lakkad'))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.Button, {
    id: "statick-blck-add-more-btn",
    variant: "primary",
    onClick: () => addNewPostdata()
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Add more', 'h-lakkad')))) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "dynamic-block-option-container"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Dynamic Posts', 'h-lakkad')), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_select__WEBPACK_IMPORTED_MODULE_8__["default"], {
    options: options,
    isMulti: true,
    onChange: categorySelection,
    value: attributes.posts_cat
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "dynamic-posts-container"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", {
    className: "posts-lists"
  }, defaultPosts.map(post => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", null, " ", post.title.rendered, " "))))));
}
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"create-block/the-first-block","version":"0.1.0","title":"The First Block","category":"widgets","icon":"smiley","description":"Example block scaffolded with Create Block tool.","supports":{"html":true,"color":{},"spacing":{"margin":true,"padding":true}},"textdomain":"the-first-block","editorScript":"file:./index.js","editorStyle":"file:./index.css","attributes":{"block_type":{"type":"string","default":"static"},"static_posts":{"type":"array","source":"query","selector":".static-post-item","default":[],"query":{"mediaId":{"type":"number","source":"attribute","attribute":"data-id","selector":"img"},"mediaURL":{"type":"string","source":"attribute","attribute":"src","selector":"img"},"postText":{"type":"string","source":"attribute","attribute":"data-text","selector":"p"},"postLink":{"type":"string","source":"attribute","attribute":"data-link","selector":"a"}}},"posts_cat":{"type":"array","default":[]}},"style":"file:./style-index.css"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkthe_first_block"] = globalThis["webpackChunkthe_first_block"] || [];
